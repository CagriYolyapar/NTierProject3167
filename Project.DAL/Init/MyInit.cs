    ...
    public class MyInit:CreateDatabaseIfNotExists<MyContext>
    {
        protected override void Seed(MyContext context)
        {
            ...
            for (int i = 2; i < 12; i++)
            {
                ...
                profile.ID = i; //Birebir ilişki oldugundan dolayı üst tarafta olusturulan AppUser'ların ID'leri ile bunlar eşleşmek zorundadır...O yüzden döngünün iterasyonunu 2'den baslattık...
