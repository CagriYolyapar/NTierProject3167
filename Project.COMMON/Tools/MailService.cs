...
namespace Project.COMMON.Tools
{
    ...
    {
        public static void Send(string receiver, string password = "atlkbjteiruyhcww", string body = "Test mailidir", string subject = "Email testi", string sender = "yzl3157test@gmail.com")
        {
